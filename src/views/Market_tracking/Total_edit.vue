<template>
  <div class="wrap">
    ...
    <div class="addtablebutton">
      <el-button class="addtablebuttonmin" type="primary" @click="submit">确认更新</el-button>
...
export default {
  ...
  mounted() {
    ...
    this.projectName = v[0].projectName;
    this.contractAmount = v[0].contractAmount;
    this.trackingNumber = v[0].trackingNumber;
    this.principal = v[0].principal;
    this.informationSource = v[0].informationSource;
    this.valueLevel = v[0].valueLevel;
    this.remark = v[0].remark;
    let address = v[0].address.split("-");
