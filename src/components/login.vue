  ...
  <div class="login">
    ...
    <div class="loginbox">
      ...
      <div class="inputselect">
        <el-input v-model="name" placeholder="请输入用户名" class="logininput"></el-input>
        <!-- <div class="code"> -->
        <el-input v-model="password" placeholder="请输入密码" class="logininput" show-password show-code></el-input>
